      ...
      builder: (context, _) {
        ...
        return Container(
          ...
          child: switch (slot.contentType) {
            ...
            SlotContentType.history => _HistoryPane(slotIndex: slotIndex),
            SlotContentType.terminal => _TerminalPane(slotIndex: slotIndex, taskId: slot.contentId),
          },
        );
      },
    );
